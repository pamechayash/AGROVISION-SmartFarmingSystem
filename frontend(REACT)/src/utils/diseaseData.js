  ...
  ,"While the spores can travel for miles, most of the ones that could infect your tree are within a few hundred feet"
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot':{"Crop": "Corn","Disease": "Grey Leaf Spot",
      ...
      "In order to best prevent and manage corn grey leaf spot, the overall approach is to reduce the rate of disease growth and expansion",
       ...
       "High risk factors for grey leaf spot in corn: Susceptible hybrid, Continuous corn, Late planting date, Minimum tillage systems, Field history of severe disease, Early disease activity (before tasseling), Irrigation,Favorable weather forecast for disease" ],
...
[
   ...
   "The black rot fungus overwinters in canes, tendrils, and leaves on the grape vine and on the ground. Mummified berries on the ground or those that are still clinging to the vines become the major infection source the following spring",

       "During rain, microscopic spores (ascospores) are shot out of numerous, black fruiting bodies (perithecia) and are carried by air currents to young, expanding leaves. In the presence of moisture, these spores germinate in 36 to 48 hours and eventually penetrate the leaves and fruit stems.",

       ,"The infection becomes visible after 8 to 25 days. When the weather is wet, spores can be released the entire spring and summer providing continuous infection"],


    "How to prevent/cure the disease":
        ["Space vines properly and choose a planting site where the vines will be exposed to full sun and good air circulation. Keep the vines off the ground and insure they are properly tied, limiting the amount of time the vines remain wet thus reducing infection.",
    ...
    "Cause of disease":[],
    "How to prevent/cure the disease": ["Don't worry. Your crop is healthy. Keep it up !!!"],
},
    ...
    'Grape___Esca_(Black_Measles)': {"Crop": "Grape", "Disease": "Black Measles",
        ...
        "Black Measles is caused by a complex of fungi that includes several species of Phaeoacremonium, primarily by P. aleophilum (currently known by the name of its sexual stage, Togninia minima), and by Phaeomoniella chlamydospora.",

        "The overwintering structures that produce spores (perithecia or pycnidia, depending on the pathogen) are embedded in diseased woody parts of vines. The overwintering structures that produce spores (perithecia or pycnidia, depending on the pathogen) are embedded in diseased woody parts of vines.",

         "During fall to spring rainfall, spores are released and wounds made by dormant pruning provide infection sites.",
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)':{ "Crop" : "Grape" ,"Disease": "Leaf Spot", "Cause of disease":[],"How to prevent/cure the disease":[]},
...
"How to prevent/cure the disease":[
    ...
    'Peach___Bacterial_spot': {"Crop": "Peach", "Disease": "Bacterial Spot",
       "Cause of disease":
        ...
        ["The disease is caused by four species of Xanthomonas (X. euvesicatoria, X. gardneri, X. perforans, and X. vesicatoria). In North Carolina, X. perforans is the predominant species associated with bacterial spot on tomato and X. euvesicatoria is the predominant species associated with the disease on pepper.",
...
"In transplant production greenhouses, minimize overwatering and handling of seedlings when they are wet.",
    ...
    'Potato___Early_blight':{ "Crop": "Potato" ,"Disease": "Early Blight",
       "Cause of disease":
        ...
        ["Early blight (EB) is a disease of potato caused by the fungus Alternaria solani. It is found wherever potatoes are grown.", 

         "The disease primarily affects leaves and stems, but under favorable weather conditions, and if left uncontrolled, can result in considerable defoliation and enhance the chance for tuber infection. Premature defoliation may lead to considerable reduction in yield.",

      "Primary infection is difficult to predict since EB is less dependent upon specific weather conditions than late blight."],
        "How to prevent/cure the disease":[
  ...
  "Provide good air movement around plants through proper spacing, staking of plants and weed control.",
    ...
    'Strawberry___Leaf_scorch': {"Crop": "Strawberry","Disease": "Leaf Scorch",
      ...
      "Strawberries with leaf scorch may first show signs of issue with the development of small purplish blemishes that occur on the topside of leaves.",],
        ...
        "How to prevent/cure the disease":
       ["Since this fungal pathogen over winters on the fallen leaves of infect plants, proper garden sanitation is key.",
...
[
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': {"Crop": "Tomato","Disease": "Two-spotted spider mite",
      "Cause of disease":[
       ...
       "The two-spotted spider mite is the most common mite species that attacks vegetable and fruit crops.",
